...
# Date: 20 MAY 2016
# Project: Move Sprite with Arrow Keys 
# Source: https://www.daniweb.com/programming/software-development/code/492990/move-a-sprite-with-arrow-keys-pygame
